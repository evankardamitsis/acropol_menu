...
const Info = () => {
  return (
    <div className="info">
      <h4>
        Η υπηρεσία έχει επιβάρυνση +2.00€ ανά παραγγελία / Room Service fee is
        +2.00€ per order
      </h4>
      ...
      <p>
        ...
        We use extra virgin olive oil in our salads and cooked meals . For
        frying we use high quality sunflower oil.
      </p>
      <p>
      ...
      <p>* Το προϊόν είναι κατεψυγμένο / * Frozen product .</p>
      <style jsx>{`
        .info {
          color: #202021;
          background: #f7f5f5;
